...
const AgentTripsPage = () => {
  ...
  return (
    <div class="flex flex-col items-center" style={{ backgroundImage: "url('/agentTripDeets.jpg')", backgroundSize: 'cover', backgroundPosition: 'center', backgroundColor: "#4a5568", backgroundBlendMode: "multiply" }}>
      ...
      {(agentTrips.length === 0) ? (
        <div class="flex flex-col justify-center items-center my-52">
          <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl dark:text-white">Your agency has no <span class="underline underline-offset-3 decoration-8 decoration-blue-400 dark:decoration-blue-600">Uploaded Trips</span></h1>
