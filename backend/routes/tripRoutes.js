...
const { getTrips, setTrip, updateTrip, deleteTrip , getUsertrips, getOneTrip, sortTrips, cancelTrip, registerForTrip, unregisterForTrip, addTripReview,} = require('../controllers/tripController')
